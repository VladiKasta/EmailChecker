...
const MessagePage: FC = () => {
  ...
  const [endingList, setEnding] = useState(3);
  ...
  return (
    <div className={styles.wrapper}>
      <h3 className={styles.title} onClick={() => console.log(msgData?.links)}>
        Cообщениe {id}:
      </h3>
      <div className="data">
        {msgData?.links == (undefined || null) && msgData
          ? "Нет ссылок в сообщении"
          : /*  <ColorRing
            visible={showLoader}
            height="80"
            width="80"
          ...
          /> */
            ...
            msgData?.links?.slice(0, endingList).map((link, index) => (
